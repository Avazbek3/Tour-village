...
import ProgramTour from '../../components/ProgramTour';
    ...
    <>
      {loading ? (
        ...
        <HotelStyle>
          ...
          {detail?.about_tour && detail?.about_tour.length > 0 ? (
          ...
          {detail?.programs && detail?.programs.length > 0 ? (
            <ProgramTour h3='Tur dasturi' data={detail?.programs} />
          ) : null}
          {detail?.services && detail?.services.length > 0 ? (
            <ServiceTour
              h3='Tur narxiga nimalar kiradi'
              data={detail?.services}
            />
          ) : null}

          <Lastm>
            <LastMarks marks={detail?.reviews} h3='Tur haqidagi fikrlar' />
            <div className='container'>
              <button
                href=''
                className='l-review'
